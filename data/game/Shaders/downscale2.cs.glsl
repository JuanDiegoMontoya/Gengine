...
void main()
{
  ...
  filterSum += textureLod(s_source, uv + texel * vec2(-2, -2), 0).rgb * (1.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(2, -2) , 0).rgb * (1.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(-2, 2) , 0).rgb * (1.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(2, 2)  , 0).rgb * (1.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(0, 2)  , 0).rgb * (2.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(0, -2) , 0).rgb * (2.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(2, 0)  , 0).rgb * (2.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(-2, 0) , 0).rgb * (2.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(0, 0)  , 0).rgb * (4.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(-1, -1), 0).rgb * (4.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(1, -1) , 0).rgb * (4.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(-1, 1) , 0).rgb * (4.0 / 32.0);
  filterSum += textureLod(s_source, uv + texel * vec2(1, 1)  , 0).rgb * (4.0 / 32.0);
