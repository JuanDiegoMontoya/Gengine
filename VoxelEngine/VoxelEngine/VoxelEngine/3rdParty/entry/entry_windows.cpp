	...
	struct Context
	{
		...
		int32_t run(int _argc, const char* const* _argv)
		{
			...
			while (!m_exit)
			{
				...
				s_xinput.update(m_eventQueue); //If you get an error thrown here like I did, you probably messed up in a shader... for me I was simply using an incorrect texture~Colton
