...
#include <../Headers/android_native_app_glue.h>
#include <android/native_window.h>

bx::FileReaderI* GlobalFileReader = nullptr;

extern "C"
{
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wunused-parameter"
#include <../Headers/android_native_app_glue.c>
...
namespace entry
{
	...
	{
		Context()
			: m_window(NULL), m_filereader(nullptr, nullptr)
		{
      ...
      m_filereader = FileReaderAndroid(m_app->activity->assetManager, nullptr);
      GlobalFileReader = &m_filereader;
    ...
    FileReaderAndroid m_filereader;
	};
